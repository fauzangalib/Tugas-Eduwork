...
function getNews(keyword) {
    return fetch('https://newsapi.org/v2/everything?q=' + keyword + '&sortBy=popularity&apiKey=d50d38a9e166421abc022d847ace3358')
    .then(response => {
        if(!response.ok){
...
fetch('https://newsapi.org/v2/top-headlines?country=id&apiKey=d50d38a9e166421abc022d847ace3358')
